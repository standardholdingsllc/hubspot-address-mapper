...
export default function ExcludedNamesPage() {
  ...
  const handleAddUsername = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        setMessage(data.message || `Added "${data.username}" to exclusion list`);
        if (data.warning) {
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-yellow-700">
                  <p>
                    Changes to the exclusion list are temporary and will reset when the application restarts. 
                    For persistent changes, you may need to manually update the names.json file in your repository.
                  </p>
                </div>
              </div>
            </div>
